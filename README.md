...
- [Linux x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/v1.3.0/ede-linux-x64)
- [macOS arm64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/v1.3.0/ede-macos-arm64)
- [macOS x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/v1.3.0/ede-macos-x64)
- [Windows x64](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/v1.3.0/ede-windows-x64.exe)
- [Windows x64 (baseline)](https://github.com/daanlenaerts/erpnext-auto-attach/releases/latest/download/v1.3.0/ede-windows-x64-baseline.exe)
